...
namespace App
{
	...
	//-------------------------------------------------------------------------------------------
	CSimpleSprite *CreateSprite(const char *fileName, int columns, int rows);
	Bullet* CreateBullet(const char* fileName, int columns, int rows); //Adds in bullet object
	Turret* CreateTurret(const char* fileName, int columns, int rows); //Adds in turret object
	Fuel* CreateFuel(const char* fileName, int columns, int rows); //Adds in fuel object
	bool CheckCollision(CSimpleSprite* sprite1, CSimpleSprite* sprite2); //Check collisions between two CSimpleSprite objects
